...
GameObject(UiObject, Rect), Position(Coord),
...
GameObject, Postion, MapUpdate(MapMovable)
...
Game, Linker(UIFactory)

###### ~~Levels::~~

###### Model:: 

GameObject(Rect, Ship), Position, MapUpdate(MapMovable, GameMap)

###### UI::

Map(console\_game\_map), GameObject(console\_ship, console\_ui\_obj), Level(console\_ui\_factory)
...
GameObject(Movable, Collisionable, Mario), Position, MapUpdate,

###### UI:: 

Map, GameObject(console\_mario), Level
...
Map, Level, GameObj, Adapter(console\_ui\_obj\_rect\_adapter)
...
Level(GameLevel, FirstLevel, SecondLevel)

###### Model:: 

Position, GameObject, MapUpdate, Linker(UIFactory)
...
Position, GameObject(Box), MapUpdate, Linker, Adapter(Rect-MapMove)

###### UI:: 

Map, Level, GameObj(console\_box), Adapter
...
Position, GameObject(Enemy), MapUpdate, Linker, Adapter

###### UI::

Map, Level, GameObj(console\_enemy), Adapter
...
Position, GameObject(FullBox, Money), MapUpdate, Linker, Adapter

###### UI:: 

Map, Level, GameObj(console\_full\_box, console\_money), Adapter
